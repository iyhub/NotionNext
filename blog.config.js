...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '阿歪', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '阿歪 | Java开发工程师 | 全栈成长中 | 出海新人🚀', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://iwhy.dev', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '程序员阿歪,阿歪,架构师,Java,Java笔记,学习java,java,Java阿歪,java阿歪,阿歪java,iy,javaiy,0基础学Java,0基础学编程,编程', // 网站关键词 英文逗号隔开
